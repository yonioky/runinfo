...
REGION_MAP = [
    # 서울 — 서울 지명 + 서울 내 대표 장소명 포함 (경기보다 먼저)
    (r"서울|여의도|광화문|상암|잠실|뚝섬|올림픽공원|한강.{0,4}공원|월드컵공원|평화의.{0,3}공원|평화광장"
     r"|마포구|마포구청|강남구|강북구|송파구|영등포구|용산구|성동구|종로구|관악구|구로구"
     r"|도봉구|노원구|은평구|서대문구|동대문구|강동구|강서구|금천구|서초구|양천구|중랑구"
     r"|청계.{0,4}광장|청계천|광평교|뚝섬한강|문화비축기지|월드컵|영등포|강남대로", "서울"),
    # 제주 — 경기 패턴보다 먼저 (제주종합경기장 오분류 방지)
    (r"제주", "제주"),
    # 경기 — '경기도' 또는 시군명으로만 매칭 (경기장 오분류 방지)
    (r"경기도|인천|수원|성남|고양|부천|안산|화성|용인|평택|시흥|파주|의정부|남양주|김포"
     r"|안양|광명|과천|하남|의왕|군포|오산|이천|안성|양주|동두천|구리시|여주|포천|연천|가평|양평"
     r"|미사경정|미사강변|남한산", "경기"),
    ...
    (r"전라|광주|전주|여수|순천|목포|익산|군산|나주|광양|담양|곡성|구례|고흥|보성|화순|장흥|강진|해남|영암|무안|함평|영광|장성|완도|진도|신안|남원|정읍|고창|부안|임실|순창|무주|진안|장수|무등산", "전라"),
    (r"경상|경북|경남|부산|대구|울산|포항|창원|구미|안동|경주|진주|거제|통영|사천|김해|밀양|거창|합천|의령|함안|창녕|남해|하동|산청|함양|고령|성주|칠곡|예천|영주|영양|청송|울진|울릉|봉화|의성|군위|영천|청도|경산|달성|문경|상주|두류공원|앞산|수성", "영남"),
]
